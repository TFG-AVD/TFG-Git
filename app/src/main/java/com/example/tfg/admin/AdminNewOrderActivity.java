...
public class AdminNewOrderActivity extends AppCompatActivity {
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView usuarioTelefono;
        public TextView usuarioPrecioTotal;
        public TextView usuarioFechaPedido;
        public TextView usuarioDireccion;
        public Button mostrarPedidosBtn;

        public AdminOrdersViewHolder(View itemView) {
            super(itemView);

            usuarioNombre = itemView.findViewById(R.id.pedido_nombre_usuario);
            usuarioTelefono = itemView.findViewById(R.id.pedido_telefono_usuario);
            usuarioPrecioTotal = itemView.findViewById(R.id.pedido_precio_total);
            usuarioFechaPedido = itemView.findViewById(R.id.pedido_fecha_hora);
            usuarioDireccion = itemView.findViewById(R.id.pedido_direccion_ciudad);
            mostrarPedidosBtn = itemView.findViewById(R.id.mostrar_productos_btn);
        }
    }
