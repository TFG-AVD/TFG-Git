    ...
    private void setAmswer(){
        ...
        if (question1.equals("") && question2.equals("")){
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference()
                    .child("Users").child(Prevalent.usuarioOnline.getPhone());
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(ResetPasswordActivity.this, "Has determinado las preguntas de seguridad con éxito", Toast.LENGTH_SHORT).show();
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()){
                        ...
                        if (dataSnapshot.hasChild("Security Questions")){
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "No has determinado las preguntas de seguridad", Toast.LENGTH_SHORT).show();
                        }
                    }else {
